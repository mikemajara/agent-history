...
| #12 | CLOSED | [Color-code agent badges in TUI session rows](https://github.com/mikemajara/agent-history/issues/12) | `agent-ready`, `priority:medium`, `status:doing`, `type:nit` | - | 2026-08-12 |
